...
const methods = {
  ...
  put(object, source, destination) {
    ...
    // TODO: [>=0.1.0] Check if you can move an item up inside a nested set of containers whose parent is closed to you.
  ...
  // console.log('OBJECT:')
  // console.log(JSON.stringify(em.getComponent('ObjectProperties', object), null, 2))
  // console.log('SOURCE:')
  // console.log(JSON.stringify(em.getComponent('ObjectProperties', source), null, 2))
  // console.log(JSON.stringify(em.getComponent('Container', source), null, 2))
  // let s = em.getComponent('Location', source).getParent()
  // while (s) {
  //     console.log('SOURCE PARENT:')
  //     console.log(JSON.stringify(em.getComponent('ObjectProperties', s), null, 2))
  //     console.log(JSON.stringify(em.getComponent('Container', s), null, 2))
  //     s = em.getComponent('Location', s).getParent()
  // }
  // console.log('DESTINATION:')
  // console.log(JSON.stringify(em.getComponent('ObjectProperties', destination), null, 2))
  // console.log(JSON.stringify(em.getComponent('Container', destination), null, 2))
  // let d = em.getComponent('Location', destination).getParent()
  // while (d) {
  //     console.log('DESTINATION PARENT:')
  //     console.log(JSON.stringify(em.getComponent('ObjectProperties', d), null, 2))
  //     console.log(JSON.stringify(em.getComponent('Container', d), null, 2))
